...
<TabItem value="result" label="Result" default>
  <HtmlCode bootstrapVersion="4.5">
      <div dangerouslySetInnerHTML={{ __html: `<img alt="Responsive image" class="img-fluid" src="/twbs-helper-module/img/docs/responsive.svg"/>` }}></div>
  </HtmlCode>
</TabItem>
...
<TabItem value="result" label="Result" default>
  <HtmlCode bootstrapVersion="4.5">
      <div dangerouslySetInnerHTML={{ __html: `<img alt="Image thumbnail" class="img-thumbnail" src="/twbs-helper-module/img/docs/200x200.svg"/>` }}></div>
  </HtmlCode>
</TabItem>
<TabItem value="source" label="Source">
...
<TabItem value="result" label="Result" default>
  <HtmlCode bootstrapVersion="4.5">
      <div dangerouslySetInnerHTML={{ __html: `<img alt="Image aligned left" class="float-left rounded" src="/twbs-helper-module/img/docs/200x200.svg"/>
<img alt="Image aligned right" class="float-right rounded" src="/twbs-helper-module/img/docs/200x200.svg"/>
<img alt="Image aligned block" class="d-block mx-auto rounded" src="/twbs-helper-module/img/docs/200x200.svg"/>` }}></div>
  </HtmlCode>
</TabItem>
<TabItem value="source" label="Source">
