...
<Tabs>
<TabItem value="result" label="Result" default><HtmlCode bootstrapVersion="4.5"><nav aria-label="Page navigation example">
    <ul class="pagination">
...
$oPaginator = new \Laminas\Paginator\Paginator(
