...
[Twitter bootstrap Documentation](https://getbootstrap.com/docs/5.3/components/progress/)

## How it works

[Twitter bootstrap Documentation](https://getbootstrap.com/docs/5.3/components/progress/#how-it-works)
...
[Twitter bootstrap Documentation](https://getbootstrap.com/docs/5.3/components/progress/#labels)
...
[Twitter bootstrap Documentation](https://getbootstrap.com/docs/5.3/components/progress/#height)

<Tabs>
<TabItem value="result" label="Result" default>
  <HtmlCode bootstrapVersion="5.3">
      <div dangerouslySetInnerHTML={{ __html: `<div class="progress" style="height: 1px;">
    <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="25" class="progress-bar" role="progressbar" style="width: 25%;"></div>
</div>
...
[Twitter bootstrap Documentation](https://getbootstrap.com/docs/5.3/components/progress/#backgrounds)
...
[Twitter bootstrap Documentation](https://getbootstrap.com/docs/5.3/components/progress/#multiple-bars)
...
[Twitter bootstrap Documentation](https://getbootstrap.com/docs/5.3/components/progress/#striped)
...
[Twitter bootstrap Documentation](https://getbootstrap.com/docs/5.3/components/progress/#animated-stripes)

<Tabs>
<TabItem value="result" label="Result" default>
  <HtmlCode bootstrapVersion="5.3">
      <div dangerouslySetInnerHTML={{ __html: `<div class="progress">
    <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="75" class="progress-bar progress-bar-animated progress-bar-striped" role="progressbar" style="width: 75%;"></div>
</div>` }}></div>
  </HtmlCode>
</TabItem>
<TabItem value="source" label="Source">
