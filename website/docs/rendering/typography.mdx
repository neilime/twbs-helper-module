...
<TabItem value="result">{ ReactHtmlParser(`<p><abbr title="attribute">attr</abbr></p>
<p><abbr class="initialism" title="HyperText&#x20;Markup&#x20;Language">HTML</abbr></p>`) }</TabItem>
...
<TabItem value="result">{ ReactHtmlParser(`<blockquote class="blockquote">
...
<TabItem value="result">{ ReactHtmlParser(`<blockquote class="blockquote&#x20;text-center">
    <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante.</p>
    <footer class="blockquote-footer">Someone famous in <cite title="Source Title">Source Title</cite></footer>
</blockquote>
...
<TabItem value="result">{ ReactHtmlParser(`<ul class="list-unstyled">
...
<TabItem value="result">{ ReactHtmlParser(`<ul class="list-inline">
