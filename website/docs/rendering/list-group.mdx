...
<TabItem value="result">{ ReactHtmlParser(`<ul class="list-group">
...
<TabItem value="result">{ ReactHtmlParser(`<div class="list-group">
...
<TabItem value="result">{ ReactHtmlParser(`<ul class="list-group&#x20;list-group-flush">
    <li class="list-group-item">Cras justo odio</li>
    <li class="list-group-item">Dapibus ac facilisis in</li>
    <li class="list-group-item">Morbi leo risus</li>
    <li class="list-group-item">Porta ac consectetur ac</li>
...
<TabItem value="result">{ ReactHtmlParser(`<ul class="list-group&#x20;list-group-horizontal">
    <li class="list-group-item">Cras justo odio</li>
    <li class="list-group-item">Dapibus ac facilisis in</li>
    <li class="list-group-item">Morbi leo risus</li>
</ul>
