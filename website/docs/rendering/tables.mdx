...
<TabItem value="result">{ ReactHtmlParser(`<table class="table">
    <thead>
        <tr>
            <th scope="col">#</th>
...
<TabItem value="result">{ ReactHtmlParser(`<table class="table&#x20;table-striped">
    <thead>
        <tr>
            <th scope="col">#</th>
            <th scope="col">First</th>
...
<TabItem value="result">{ ReactHtmlParser(`<table class="table&#x20;table-bordered">
    <thead>
        <tr>
            <th scope="col">#</th>
            <th scope="col">First</th>
...
<TabItem value="result">{ ReactHtmlParser(`<table class="table&#x20;table-borderless">
    <thead>
        <tr>
            <th scope="col">#</th>
            <th scope="col">First</th>
...
<TabItem value="result">{ ReactHtmlParser(`<table class="table&#x20;table-hover">
    <thead>
        <tr>
            <th scope="col">#</th>
            <th scope="col">First</th>
...
<TabItem value="result">{ ReactHtmlParser(`<table class="table&#x20;table-sm">
    <thead>
        <tr>
            <th scope="col">#</th>
            <th scope="col">First</th>
...
<TabItem value="result">{ ReactHtmlParser(`<div class="table-responsive">
    <table class="table">
        <thead>
            <tr>
                <th scope="col">#</th>
...
<TabItem value="result">{ ReactHtmlParser(`<div class="table-responsive-sm">
    <table class="table">
        <thead>
            <tr>
                <th scope="col">#</th>
