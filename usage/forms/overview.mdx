...
[Twitter bootstrap Documentation](https://getbootstrap.com/docs/5.3/forms/overview)

## Overview

[Twitter bootstrap Documentation](https://getbootstrap.com/docs/5.3/forms/overview/#overview)
...
[Twitter bootstrap Documentation](https://getbootstrap.com/docs/5.3/forms/overview/#form-text)
...
<br>
<form class="align-items-center g-3 row" id="form" method="POST" name="form" role="form">
    <div class="col-auto">
...
[Twitter bootstrap Documentation](https://getbootstrap.com/docs/5.3/forms/overview/#disabled-forms)
