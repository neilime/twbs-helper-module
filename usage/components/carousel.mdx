...
[Twitter bootstrap Documentation](https://getbootstrap.com/docs/5.3/components/carousel/)

## Example

[Twitter bootstrap Documentation](https://getbootstrap.com/docs/5.3/components/carousel/#example)

### Slides only

[Twitter bootstrap Documentation](https://getbootstrap.com/docs/5.3/components/carousel/#slides-only)
  ...
  <HtmlCode bootstrapVersion="5.3">
    ...
    <div class="carousel-inner">
        <div class="active carousel-item">
            <img alt="..." class="d-block w-100" src="/twbs-helper-module/img/docs/slide1.svg">
        </div>
        <div class="carousel-item">
            <img alt="..." class="d-block w-100" src="/twbs-helper-module/img/docs/slide2.svg">
        </div>
        <div class="carousel-item">
            <img alt="..." class="d-block w-100" src="/twbs-helper-module/img/docs/slide3.svg">
        </div>
    </div>
</div>` }}></div>
  </HtmlCode>
...
[Twitter bootstrap Documentation](https://getbootstrap.com/docs/5.3/components/carousel/#with-controls)
...
[Twitter bootstrap Documentation](https://getbootstrap.com/docs/5.3/components/carousel/#with-indicators)
...
[Twitter bootstrap Documentation](https://getbootstrap.com/docs/5.3/components/carousel/#with-captions)
...
[Twitter bootstrap Documentation](https://getbootstrap.com/docs/5.3/components/carousel/#crossfade)
...
[Twitter bootstrap Documentation](https://getbootstrap.com/docs/5.3/components/carousel/#individual-carousel-item-interval)
...
[Twitter bootstrap Documentation](https://getbootstrap.com/docs/5.3/components/carousel/#disable-touch-swiping)
...
[Twitter bootstrap Documentation](https://getbootstrap.com/docs/5.3/components/carousel/#dark-variant)
