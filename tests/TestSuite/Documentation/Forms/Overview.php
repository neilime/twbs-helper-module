...
return [
    ...
    "tests" => [
        [
            'title' => 'Overview',
            'url' => '%bootstrap-url%/components/forms/overview/#overview',
        ...
        [
            'title' => 'Form text',
            'url' => '%bootstrap-url%/components/forms/overview/#form-text',
            'rendering' => function (\Laminas\View\Renderer\PhpRenderer $oView) {
                $oFactory = new \Laminas\Form\Factory();
            ...
            'expected' => '<label class="form-label" for="inputPassword5">Password</label>' . PHP_EOL .
                ...
                'Must be 8-20 characters long.</span>' . PHP_EOL .
                '        </div>' . PHP_EOL .
                '    </div>' . PHP_EOL .
                '</form>',
        ],
        [
            ...
            'url' => '%bootstrap-url%/components/forms/overview/#disabled-forms',
            'rendering' => function (\Laminas\View\Renderer\PhpRenderer $oView) {
                $oFactory = new \Laminas\Form\Factory();
