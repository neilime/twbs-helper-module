            ...
            'tests' => [
                ...
                [
                    ...
                    'expected' => '<dl class="row">' . PHP_EOL .
                        ...
                        '    <dd class="col-sm-9">This definition is short, so no extra paragraphs or anything.</dd>' . PHP_EOL .
                        '    <dt class="col-sm-3 text-truncate">Truncated term is truncated</dt>' . PHP_EOL .
                        '    <dd class="col-sm-9">This can be useful when space is tight. Adds an ellipsis at the end.</dd>' . PHP_EOL .
                        '    <dt class="col-sm-3">Nesting</dt>' . PHP_EOL .
                        '    <dd class="col-sm-9">' . PHP_EOL .
                        '        <dl class="row">' . PHP_EOL .
                        '            <dt class="col-sm-4">Nested definition list</dt>' . PHP_EOL .
                        '            <dd class="col-sm-8">I heard you like definition lists. Let me put a definition list inside your definition list.</dd>' . PHP_EOL .
                        '        </dl>' . PHP_EOL .
                        '    </dd>' . PHP_EOL .
                        '</dl>' . PHP_EOL
                ],
